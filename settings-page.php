...
if(!class_exists('wdm_settings'))
{
	...
	<div class="wrap" id="wdm_auction_setID">
	    ...
	    <h2><?php _e('Ultimate Auction', 'wdm-ultimate-auction');?></h2>
          <div id="ultimate-auction-banner"><a href="http://auctionplugin.net" target="_blank"><img src="<?php echo plugins_url('/img/banner.jpg',__FILE__);?>" /></a>
          <a href="https://wordpress.org/support/view/plugin-reviews/ultimate-auction" target="_blank"><img id="wdm_review" src="<?php echo plugins_url('/img/review3.png',__FILE__);?>" /></a>
          </div>
